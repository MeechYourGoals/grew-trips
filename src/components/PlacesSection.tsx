  ...
  return (
    <div className="mb-12">
      <div className="flex justify-between items-center mb-8">
        ...
        <button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 py-4 rounded-2xl flex items-center gap-3 transition-all duration-300 hover:scale-105 shadow-xl shadow-blue-500/25 font-semibold">
          <Plus size={20} />
          Add Place
        </button>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-3xl p-16 text-center shadow-lg shadow-gray-200/50">
        ...
        <button className="bg-white hover:bg-gray-50 text-gray-900 px-8 py-4 rounded-2xl transition-all duration-200 shadow-lg shadow-gray-200/50 border border-gray-200 hover:shadow-xl font-medium">
          Add Place
        </button>
      </div>
    </div>
