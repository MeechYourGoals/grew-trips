...
export class SciraAIService {
  ...
  static buildTripContext(tripContext: TripContext): string {
    ...
    let context = `You are Concierge, an intelligent travel assistant with deep knowledge of this specific trip. Answer questions concisely and provide actionable insights.
